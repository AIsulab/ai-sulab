...
function NavLogo({ size = 26 }) {
  return (
    <img src={window.__resources && window.__resources.sulabLogo ? window.__resources.sulabLogo : "assets/sulab-logo.png"} alt="sulab" style={{ height: size + "px", width: "auto" }} className="block select-none" draggable="false"/>
  );
}
